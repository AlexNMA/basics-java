...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ContactRepositoryInDataBase contactRepository;
        contactRepository = new ContactRepositoryInDataBase();
        int option;
        ...
        while (CONTINUE) {
            ...
            switch (option) {
                ...
                case 3: {
                    ...
                    contactRepository.setInDataBase(contact);
                ...
                case 4: {
                    ...
                    System.out.println("Are you sure you want to delete " +
                            contactRepository.getFromDataBase(removeID).getName() + " ?");
